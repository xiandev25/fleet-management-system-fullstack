        ...
        <div class="flex-grow overflow-y-auto p-5">
          ...
          <div v-else class="space-y-3">
            ...
            >
              ...
              <!-- Delete -->
              <button @click="deleteStop(stop.id)" v-show="stop.sequence_number === sortedStops.length" class="text-status-stop hover:bg-status-stop/10 p-2 rounded-lg transition-colors flex-shrink-0">
